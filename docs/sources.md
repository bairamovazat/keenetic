...
- `docs/manuals/keenetic-ultra-kn-1811-instrukcia-ru.pdf` — печатная «Инструкция по применению».
  NB: внутри фигурирует модель KN-1810/AC2600 (предыдущая ревизия Ultra) — общая часть верна,
  характеристики KN-1811 см. docs/router.md.
