...
Основной VPN и сплит трафика. VLAN/IPSec НЕ используем (решение владельца, 2026-09-18):
управление — пользовательские политики Keenetic + IPSET/geosite поверх основной сети.
